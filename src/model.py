...
class UserData(db.Model):
    ...
    user_id = db.Column(db.String(44), db.ForeignKey('user_login.id'), nullable=False)
...
class Swipe(db.Model):
    ...
    front_user = db.Column(db.String(44), db.ForeignKey('user_login.id'), nullable=False)
    #The user that is swiped upon
    back_user = db.Column(db.String(44), db.ForeignKey('user_login.id'), nullable=False)
